...
import {
  ...
  Image, Animated, ScrollView, Share, Dimensions,
} from "react-native";
    ...
    <View style={s.root}>
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <ScrollView showsVerticalScrollIndicator={false} bounces={false}>
          {/* Title */}
          <Animated.View
            style={[s.titleWrap, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}
          >
            <View style={s.successBadge}>
              <Text style={s.successBadgeText}>✓ Pronto!</Text>
            </View>
            <Text style={s.title}>O teu novo{"\n"}visual</Text>
            {styleName ? (
          ...
          {/* Before/After */}
          <Animated.View style={[s.compareWrap, { opacity: fadeAnim }]}>
            <View style={s.compareRow}>
              {/* Before */}
              <View style={s.compareCard}>
                <View style={s.compareImg}>
                  {originalUri ? (
...
const s = StyleSheet.create({
  ...
  compareImg: { height: 220, position: "relative" },
  ...
  demoText: {
    fontFamily: FONTS.body, fontSize: 11, color: COLORS.textTertiary, marginTop: 4,
  },
  imgGradient: {
  ...
  ratingTitle: {
    fontFamily: FONTS.bodyMedium, fontSize: 14, color: COLORS.textSecondary, marginBottom: 12,
  },
