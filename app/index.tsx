...
const FEATURES = [
  {
    icon: '📸',
    num: '01',
    title: 'Envia a tua selfie',
    desc: 'Rosto visível, boa iluminação, fundo neutro. Quanto melhor a foto, melhor o resultado.',
  },
  {
    icon: '✂️',
    num: '02',
    title: 'Escolhe o estilo',
    desc: '10 cortes com prompts de IA otimizados para testares o look antes de cortar.',
  },
  {
    icon: '⚡',
    num: '03',
    title: 'Vê o resultado',
    desc: 'A IA gera o teu novo look em segundos. Compara antes e depois e partilha com os amigos.',
  },
];
...
const TESTIMONIALS = [
  {
    name: 'Miguel S.',
    location: 'Lisboa',
    text: 'Fui ao barbeiro sem dúvidas pela primeira vez na vida. Incrível o que a IA consegue fazer.',
  },
  {
    name: 'Diogo F.',
    location: 'Porto',
    text: 'Experimentei o mid fade antes de ir ao barbeiro. Ficou muito mais fácil decidir.',
  },
  {
    name: 'Tomás R.',
    location: 'Braga',
    text: 'A minha mulher aprovou o corte antes de eu ir ao barbeiro. Nunca mais houve surpresas.',
  },
];

const STATS = [
  { num: 'Rápido', label: 'Pré-visualiza o corte em poucos passos' },
  { num: 'Simples', label: 'Basta uma selfie para começar' },
  { num: 'Útil', label: 'Vê o look antes de ir ao barbeiro' },
  { num: 'Fácil', label: 'Testa sem complicações' },
];
          ...
          <View style={[s.heroInner, isWeb && s.heroInnerWeb]}>
            <View style={[s.heroLeft, isWeb && s.heroLeftWeb]}>
              ...
              <Text style={[s.sub, isWeb && s.subWeb]}>
                Envia uma selfie, escolhe o estilo e a nossa IA mostra-te como ficas — em segundos. Sem surpresas na
                cadeira do barbeiro.
              </Text>

              <TouchableOpacity
                style={[s.ctaBtn, isWeb && s.ctaBtnWeb]}
