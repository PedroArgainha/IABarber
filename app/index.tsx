...
const STATS = [
  { num: '10K+', label: 'Utilizadores' },
  { num: '50K+', label: 'Looks criados' },
  { num: '4.9★', label: 'Avaliação' },
  { num: '<10s', label: 'Tempo resposta' },
];
      ...
      <ScrollView showsVerticalScrollIndicator={false} bounces={false}>
          ...
          <View style={[s.heroInner, isWeb && s.heroInnerWeb]}>
            ...
            <View style={[s.heroLeft, isWeb && s.heroLeftWeb]}>
              <View style={s.heroBadge}>
                ...
                <Text style={s.badgeText}>Powered by IA · Grátis para testar</Text>
              </View>
                ...
                <View style={s.phoneMockup}>
                  ...
                  <View style={s.phoneScreen}>
                    <View style={s.phoneHeader}>
                      <Text style={s.phoneLogoText}><Text style={{ color: COLORS.accent }}>777</Text> HairVision</Text>
          ...
          <View style={isWeb ? s.webInner : undefined}>
            ...
            <View style={[s.stylesGrid, isWeb && s.stylesGridWeb]}>
              {STYLES.hairStyles.map((style) => (
                <TouchableOpacity
                  key={style.id}
                  style={[s.styleCard, isWeb && s.styleCardWeb]}
        ...
        <View style={[s.section, isWeb && s.sectionWeb]}>
          <View style={isWeb ? s.webInner : undefined}>
            ...
            <Text style={[s.sectionTitle, isWeb && s.sectionTitleWeb]}>Clientes reais.</Text>
              ...
              {TESTIMONIALS.map((t, i) => (
                <View key={i} style={[s.testimonialCard, isWeb && s.testimonialCardWeb]}>
                  ...
                  <View style={s.tAuthor}>
                    <View style={s.tAvatar}><Text style={{ fontSize: 16 }}>👤</Text></View>
                    <View>
...
const s = StyleSheet.create({
  ...
  heroWeb: { paddingTop: 130, paddingBottom: 100, paddingHorizontal: 0 },
  heroInner: { flex: 1 },
  heroInnerWeb: { maxWidth: MAX_WIDTH, marginHorizontal: 'auto' as any, paddingHorizontal: 48, flexDirection: 'row', gap: 80, alignItems: 'center' },
  heroLeft: {},
  heroLeftWeb: { flex: 1 },
  ...
  badgeText: { fontFamily: FONTS.body, fontSize: 12, color: COLORS.accent },
  ...
  // Phone mockup
  phoneMockup: { width: 280, backgroundColor: COLORS.bgCard, borderRadius: 36, borderWidth: 0.5, borderColor: COLORS.borderStrong, overflow: 'hidden' },
  phoneNotch: { width: 100, height: 28, backgroundColor: COLORS.bg, borderBottomLeftRadius: 20, borderBottomRightRadius: 20, alignSelf: 'center' },
  phoneScreen: { padding: 16 },
  phoneHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14, paddingHorizontal: 4 },
  ...
  phoneSub: { fontFamily: FONTS.body, fontSize: 11, color: COLORS.textSecondary, marginBottom: 12 },
  phoneUpload: { borderWidth: 1.5, borderStyle: 'dashed', borderColor: COLORS.accentBorder, borderRadius: 12, padding: 18, alignItems: 'center', backgroundColor: COLORS.accentDim, marginBottom: 12, gap: 6 },
  phoneUploadText: { fontFamily: FONTS.body, fontSize: 11, color: COLORS.textSecondary },
  phoneStylesGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginBottom: 12 },
  phoneStyleCard: { backgroundColor: COLORS.bgElevated, borderRadius: 8, paddingHorizontal: 10, paddingVertical: 7, borderWidth: 0.5, borderColor: COLORS.border },
  ...
  phoneBtn: { backgroundColor: COLORS.accent, borderRadius: 10, padding: 12, alignItems: 'center' },
